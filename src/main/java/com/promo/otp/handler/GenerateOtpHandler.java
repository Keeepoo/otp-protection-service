...
public class GenerateOtpHandler implements HttpHandler {
    ...
    public GenerateOtpHandler(OtpService otpService, UserService userService) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            String phone = data.getOrDefault("phone", "79000000000");
            String email = data.getOrDefault("email", "test@example.com");
            ...
            otpService.generateAndSend(user.getId(), operationId, phone, email);
